...
function drawCube(){
  ...
  gl.bindTexture(gl.TEXTURE_2D, cubeMapTex);
...
function animate() {
    ...
    else
    {
        ...
        modelYRotationRadians += 1.2 * deltaTime;
    }
}
...
function cubeTexSetup(){
    ...
    var cubeFaces = [
        ["resources/pos-x.png", gl.TEXTURE_CUBE_MAP_POSITIVE_X],
    ...
    for(var i = 0; i < cubeFaces.length; i++){
        ...
        } (cubeMapTex, cubeFaces[i][1], image);
        //image.src = cubeFaces[i][0];
    }
}
